...
import { PieceType, initialPieces } from '../utils/piece';
...
export const GameProvider = ({ children }) => {
    ...
    const dealPieces = () => {
        ...
        const numPiecesPerPlayer = Math.floor(shuffledPieces.length / numPlayers);
        ...
        const remainingPieces = shuffledPieces.slice(numPiecesPerPlayer * numPlayers);
    ...
    return <GameContext.Provider value={{ state, dealPieces }}>
        {children}
